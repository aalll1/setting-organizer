...
- GitHub `main` 和 `v0.2.1` tag 已推送并验证 `manifest.json` 版本为 `0.2.1`。
...
v0.2.1 本地语法检查、单元测试和 SillyTavern 1.18.0 宿主机浏览器 smoke test 通过。GitHub `main` 和 `v0.2.1` tag 已推送并验证安装元信息。当前环境缺少 ADB 且未配置真实模型，因此 MuMu/CDP 和真实模型成功路径未完成；这些限制已记录，不影响 v0.2.1 稳定性修复版发布结论。
